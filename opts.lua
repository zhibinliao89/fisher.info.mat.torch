...
function M.parse(arg)
   ...
   cmd:option('-learningRateSchedule',      1, 'Options: 1 | 2')
   ...
   cmd:option('-enableJacobian',    'false',  'Control whether to compute the Jacobian')
   cmd:option('-jacobianSamplingInterval', 50, 'Control how often to calculate the Jacobian beyond $numJacobianEvaluatingEpochs epochs')
   cmd:option('-numJacobianEvaluatingEpochs',  1e10,  'the number of epochs to evalulate the Jacobian'  )
   ---------- The commented model options for DenseNet have been hard-coded in model/DenseNet.lua --------
   ...
   cmd:option('-optMemory',          4,    'Optimize memory for DenseNet: 0 | 1 | 2 | 3 | 4 | 5', 'number')
   ...
   opt.enableJacobian = opt.enableJacobian ~= 'false'
